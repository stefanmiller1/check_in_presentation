...
class FlexibleShapeContainer extends StatelessWidget {
  final bool isTopConvex;
  final bool isBottomConvex;
  final bool isNotValid;
  final DashboardModel model;
  final Widget mainWidget;

  const FlexibleShapeContainer({
    Key? key,
    required this.isTopConvex,
    required this.isBottomConvex,
    required this.model,
    ...
    return Container(
        ...
        decoration: ShapeDecoration(
          shape: SwTicketBorder(
            radius: 28,
            fillColor: (isNotValid) ? model.paletteColor : model.accentColor,
            borderWidth: 0,
            bottomLeft: isBottomConvex,
            bottomRight: isBottomConvex,
            topLeft: isTopConvex,
            topRight: isTopConvex,
          ),
        ),
        child: mainWidget
    );
