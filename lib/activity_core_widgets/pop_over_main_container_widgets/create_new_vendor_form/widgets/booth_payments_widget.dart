...
class VendorFormBoothPaymentWidget extends StatefulWidget {
  ...
  const VendorFormBoothPaymentWidget({super.key, required this.model, required this.reservation, required this.form, required this.onChanged, this.currentBoothPayment, required this.activityForm});
